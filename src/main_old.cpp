            ...
            for(int i = 0; i < sensor_fusion.size(); i++)
            {
              ...
              if(d < (2+4*lane+2) && d > (2+4*lane-2))
              {
                ...
                if((check_car_s > car_s) && ((check_car_s-car_s) < 30))
                {
                  ...
                  {
                    d = sensor_fusion[j][6];
                    vx = sensor_fusion[j][3];
                    vy = sensor_fusion[j][4];
                    check_speed = sqrt(vx*vx+vy*vy);
                    check_car_s = sensor_fusion[j][5];
                    ...
                    if(lane == 0 | lane == 2)
                    {
                      ...
                      // if(d > 4 && d < 8)
                      // {
                      //   cout << d << ": " << check_car_s-car_s << endl;
                      // }

                      if(d > 4 && d < 8 && (check_car_s-car_s) > 30)
                      {
                        cout << "Change Lanes Center" << endl;
                        lane = 1;
                        change_lanes = true;
                      }
                    ...
                    else if(lane == 1)
                    {
                      ...
                      if(d > 8 && d < 12 && (check_car_s-car_s) > 30)
                      {
                        cout << "Change Lanes Right" << endl;
                        lane = 2;
                        change_lanes = true;
                      }
                      if(d > 0 && d < 4 && (check_car_s-car_s) > 30)
                      {
                        cout << "Change Lanes Left" << endl;
                        lane = 0;
                        change_lanes = true;
                      }
                    }
